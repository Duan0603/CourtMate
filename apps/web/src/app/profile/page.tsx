                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto">
                    {reg.status === 'PAID' || reg.status === 'APPROVED' ? (
                      ...
                      <Link
                        ...
                        className="w-full sm:w-auto px-4 py-2 rounded-xl bg-court-orange hover:bg-orange-600 text-white font-semibold text-xs flex items-center justify-center gap-1.5 transition shadow-xs"
                      >
                      ...
                      <Link
                        href={`/tournaments/${reg.tournamentId}/register`}
                        className="w-full sm:w-auto px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs flex items-center justify-center gap-1.5 transition"
                      >
